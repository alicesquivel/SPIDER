...
/****************************************************************************/
#ifndef SPIDER_RQUEUE_H
#define SPIDER_RQUEUE_H
...
/**
 * \ingroup spider
 * \brief SPIDER route request queue
 *
 * Since SPIDER is an on demand routing we queue requests while looking for route.
 */
class RequestQueue
{
public:
